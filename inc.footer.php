...
<footer id="footer" class="site-footer">
        <div class="container">
          ...
          <div id="sidebar-footer-1">
            <div class="row">
              ...
              <aside class="widget col-md-3 col-sm-6">
                ...
                <p>Here goes a little information taken from the about us page and when this is clicked it will be taken where about us information is available. <a href="#features">Read more</a></p>
              </aside>
              ...
              <aside class="widget col-md-3 col-sm-6">
                ...
                <div class="textwidget">
                  <div class="adr">
					<div class="street-address">Roy Tissera</div>
                  ...
                  <div>Website: <a class="url" href="http://www.yoarts.com/">www.RoyTours.com</a></div>
                </div>
              </aside>
          ...
          <div class="copyright"><p>© 2014 RoyTours.com<br /> Developed by <a href="#">Tistus</a></p></div>
        </div>
      </footer>